...
function createApkBox() {
    ...
    <div class="maxwin-box">
      ...
      <div class="right-panel">
        <a href="https://storetn.in/WD89/wd89.apk" target="_blank">
          <img src="https://files.sitestatic.net/CustomFiles/20260428114054000000d5b9f52635__WD89__260x350.png" alt="Download APK WD89">
        </a>
      </div>
    </div>
  `;
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://urlwin.link/wd89-login";
